# Changelog — universe-invaders

Formato: [Keep a Changelog](https://keepachangelog.com/pt-BR/1.1.0/).
SemVer. Versionamento independente do core (ver `docs/UNIVERSE-VERSIONING.md`).

## [Unreleased] <!-- regenerated via git pathspec; jj log universes/universe-invaders/ also works -->
...
- Frota de invasores, tiros do jogador e progressão de onda.
