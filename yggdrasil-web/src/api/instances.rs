...
/// Resumo leve de um universo alcançável por portal (cross-universe, YG-152).
...
/// **atravessar** a partir de `{id}` (YG-152, "universe-as-node" / CO-400).
///
...
mod tests {
    ...
    // YG-152: a partir de um universo, os portais são os outros universos VISÍVEIS
