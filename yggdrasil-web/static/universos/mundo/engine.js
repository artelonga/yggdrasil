...
export class World {
  ...
  entityAt(x, y) {
    ...
    // portais (cross-universe, YG-157): pisáveis como portas; cruzar troca de vault.
  ...
  _render(time) {
    ...
    // portais (YG-157): tema desenha se souber, senão fallback comum (data-agnóstico).
...
// Portal cross-universe (YG-157): um arco-portal pulsante, distinto de porta/saída.
