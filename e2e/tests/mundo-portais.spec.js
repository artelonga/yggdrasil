// E2E da travessia entre universos no "🌍 Mundo" (YG-152): do universo A → pisar
...
test('Mundo: A → portal → B → andar → voltar pro A (YG-152)', async ({ page, request, baseURL }) => {
  ...
  const C = await novoUniverso('Universo Secreto', tokenOutro);
  ...
  // ── ATRAVESSAR: pisa no portal → carrega o mundo de B (lazy) ──
